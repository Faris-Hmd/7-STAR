...
function payment() {
  return (
    <PageLayout pageName={"اتمام الشراء"}>
      <div class="container bg-sec p-1">
        <main>
          {/* <div class="py-5 text-center">
            ...
            <p class="lead">
              ...
              النموذج في Bootstrap. لكل مجموعة نماذج مطلوبة حالة تحقق يمكن
              تشغيلها بمحاولة إرسال النموذج دون استكماله.
            </p>
          </div> */}
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    <label for="email" class="form-label">
                      البريد الإلكتروني{" "}
                      <span class="text-body-secondary">(اختياري)</span>
                    </label>
                    <input
                      type="email"
                      class="form-control"
                  ...
                  <div class="col-12">
                    <label for="address2" class="form-label">
                      عنوان 2 <span class="text-body-secondary">(اختياري)</span>
                    </label>
                    <input
                      type="text"
                      class="form-control"
